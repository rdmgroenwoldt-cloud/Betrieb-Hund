// Lokaler Preview-Server NUR für die Hundetrainer-Landingpage.
// Root: dieses Verzeichnis.   Start: node _server.cjs   →   http://localhost:8090/
...
const PORT = 8090;
const LABEL = 'Hundetrainer & Hundeschulen';
